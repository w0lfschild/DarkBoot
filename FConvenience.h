...
#define db_plistPath   [usrLibrary stringByAppendingPathComponent:@"Preferences/org.w0lf.DarkBoot.plist"]
#define db_plistFile   [NSMutableDictionary dictionaryWithContentsOfFile:db_plistPath]
#define db_EnableText  [db_plistFile objectForKey:@"custom_text"]
#define db_LockText    [db_plistFile objectForKey:@"lock_text"]
#define db_EnableSize  [db_plistFile objectForKey:@"custom_size"]
#define db_LockSize    [db_plistFile objectForKey:@"lock_size"]
#define db_EnableAnim  [db_plistFile objectForKey:@"custom_anim"]
